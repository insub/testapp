        ...
        <form className="pa4">
          <fieldset id="favorite_movies" className="bn">
            <div className="flex items-center mb2">
              ...
              <input
                className="input-reset ba b--black-20 pa1 mb2 db ml2"
                type="number"
            ...
            <div className="flex items-center mb2">
              <input
                ...
                value="extra"
                checked={showExtra}
                onChange={this.handleToggleExtra}
              />
              <label htmlFor="extra" className="lh-copy">
                Show Extra Button
              </label>
            </div>
            <div className="flex items-center mb2">
              ...
              />
              <label htmlFor="modal" className="lh-copy">
                Show Modal Button
              </label>
            </div>
            <div className="flex items-center mb2">
              <input
                ...
                value="arrow"
                checked={showArrow}
                onChange={this.handleToggleArrow}
              />
              <label htmlFor="arrow" className="lh-copy">
                Show Arrow Button
              </label>
            </div>
          </fieldset>
