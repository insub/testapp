...
import { UPDATE_CHANNEL_STABLE, UPDATE_CHANNEL_BETA, getAppTheme } from '../common/constants';
...
export function init(): BaseSettings {
  return {
    ...
    theme: `apiplus-${getAppTheme()}`,
    pluginPath: '',
    nunjucksPowerUserMode: false,
    deviceId: null,
    updateChannel: Math.random() < 0.5 ? UPDATE_CHANNEL_BETA : UPDATE_CHANNEL_STABLE,
