...
export const SEND_REQUEST_R: Hotkey = {
  description: 'Send Request Again',
  meta: true,
  alt: false,
  shift: false,
  keycode: keycodes.r
...
export const RESTORE_REQUEST: Hotkey = {
...
export const RESTORE_REQUEST_F12: Hotkey = {
  description: 'Restore Request',
  meta: false,
  alt: false,
  shift: false,
...
// insub
export const CLOSE_ACTIVE_TAB: Hotkey = {
...
export const SAVE_REQUEST: Hotkey = {
  description: 'Save & Sync Current Request',
  meta: true,
  metaIsCtrl: true,
  alt: false,
  shift: false,
...
export const SAVE_RESPONSE: Hotkey = {
  description: 'Save & Sync Current Request',
  meta: true,
  metaIsCtrl: true,
  alt: false,
...
export const COLLAPSE_SIDEBAR: Hotkey = {
  description: 'Toggle Sidebar',
  meta: false,
  alt: false,
  shift: false,
...
export const COLLAPSE_RESPONSE: Hotkey = {
  description: 'Toggle Collapse Response',
  meta: false,
  alt: false,
  shift: false,
  keycode: keycodes.f2
...
export const TOGGLE_PANE: Hotkey = {
  description: 'Toggle Pane Mode',
  meta: false,
  alt: false,
  shift: false,
  keycode: keycodes.f3
...
export const TOGGLE_PASTER: Hotkey = {
  description: 'Toggle Paster',
  meta: false,
  alt: false,
  shift: false,
  keycode: keycodes.f4
...
export const OPEN_DEVTOOLS: Hotkey = {
