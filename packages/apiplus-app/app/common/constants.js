...
export function getAppEnvironment() {
  return process.env.APIPLUS_ENV || 'production';
}

export function getAppTheme() {
  return packageJSON.app.theme;
}

export function getTempDir() {
  // NOTE: Using a fairly unique name here because "apiplus" is a common word
  const { app } = electron.remote || electron;
  const dir = path.join(app.getPath('temp'), `apiplus_${getAppVersion()}`);
  mkdirp.sync(dir);
  return dir;
}
...
export const CHANGELOG_BASE_URL = 'https://apiplus.io/changelog';
...
export const HOST = isDevelopment() ? 'http://localhost:3000' : 'https://apiplus.io';
export const UPDATE_URL_MAC = isDevelopment() ? 'http://localhost:3000/test_updater' : `https://apiplus-updates.uihubcdn.com/${packageJSON.app.theme}/latest`;
export const UPDATE_URL_WINDOWS = isDevelopment() ? 'http://localhost:3000/test_updater' : `https://apiplus-updates.uihubcdn.com/${packageJSON.app.theme}/latest`;
export const UPDATE_URL_LINUX = isDevelopment() ? 'http://localhost:3000/test_updater' : `https://apiplus-updates.uihubcdn.com/${packageJSON.app.theme}/latest`;
...
// Hosts
export const EXAMPLE_HOSTS = ['http://localhost', 'http://localhost/api/v1', 'http://localhost:3000/api/v1', 'http://jsonplaceholder.typicode.com'];
...
export const RESPONSE_CODE_DESCRIPTIONS = {
  ...
  [STATUS_CODE_PLUGIN_ERROR]:
    'An apiplus plugin threw an error which prevented the request from sending',
