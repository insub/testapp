...
class GenerateCodeModal extends PureComponent {
  constructor(props) {
    ...
    try {
      target = JSON.parse(
        window.localStorage.getItem('apiplus::generateCode::target')
      );
    } catch (e) {}
    try {
      client = JSON.parse(
        window.localStorage.getItem('apiplus::generateCode::client')
      );
    } catch (e) {}
  ...
  async _generateCode(request, target, client) {
    ...
    window.localStorage.setItem(
      'apiplus::generateCode::client',
      JSON.stringify(client)
    );
    window.localStorage.setItem(
      'apiplus::generateCode::target',
