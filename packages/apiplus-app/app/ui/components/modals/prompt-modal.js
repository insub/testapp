...
class PromptModal extends React.PureComponent<Props, State> {
  ...
  render() {
    ...
    return (
      <Modal className="prompt_modal" ref={this._setModalRef} noEscape={!cancelable} onCancel={onCancel}>
        ...
        <ModalFooter>
          ...
          <button className="apiplusbtn submitbtn" onClick={this._handleSubmit}>
            {submitName || 'Submit'}
          </button>
        </ModalFooter>
      </Modal>
