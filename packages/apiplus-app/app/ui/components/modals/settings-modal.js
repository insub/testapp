...
export const TAB_INDEX_GENERAL = 0;
export const TAB_INDEX_EXPORT = 1;
export const TAB_INDEX_SHORTCUTS = 2;
export const TAB_INDEX_SUPPORT = 3;
...
class SettingsModal extends PureComponent {
  ...
  render() {
    ...
    return (
      <Modal className="settings_modal" ref={this._setModalRef} tall freshState {...this.props}>
        <ModalHeader>
          <div></div>
        ...
        <ModalBody noScroll>
          <Tabs className="react-tabs" defaultIndex={currentTabIndex}>
            ...
            */}
            <TabPanel className="react-tabs__tab-panel pad scrollable support_tab">
              <Support />
            </TabPanel>
          </Tabs>
        </ModalBody>
