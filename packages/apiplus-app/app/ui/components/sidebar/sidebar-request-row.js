        ...
        <li className={classes}>
          <div
            ...
            <button
              ...
              <div className="sidebar__clickable api_lsit">
                <div className="api_item">
                  <div className="api_name_box">
                  <span className={(requestMeta && requestMeta.unpush ? "status_symbol unpush " : "") + (requestMeta && requestMeta.unsave ? "status_symbol unsave" : "")} ></span>
                    {request.showid ? (
                      <span className="api_num">#{request.showid}</span>
                     ) : null}
                    <Editable
                    value={request.name}
                  ...
                  <span className="api_num_temp">{request.method}</span>
                  <span className="api_text">{request.url}</span>
                </div>
              </div>
            </button>
