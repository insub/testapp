...
const LOCALSTORAGE_KEY = 'apiplus::notifications::seen';
...
class Toast extends React.PureComponent<Props, State> {
  ...
  async _checkForNotifications() {
    console.warn("_checkForNotifications!!!")
    ...
    return (
      <div
        ...
        <div className="toast__image">
          <img className="toast_logo" src="static/logo.svg" alt="Profile picture" title="support@apiplus.io"/>
        </div>
