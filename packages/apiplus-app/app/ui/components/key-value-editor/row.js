...
class KeyValueEditorRow extends PureComponent {
  ...
  _handleDescChange(desc) {
    this._sendChange({ desc });
  }
  ...
  _handleFocusDesc(e) {
    this.props.onFocusDesc(this.props.pair, e);
  }
    ...
    const row = (
      <li className={classes}>
        ...
        <div className="key-value-editor__row">
          <div
            className={classnames('form-control form-control--underlined form-control--wide variable_name', {
          ...
          <div
            className={classnames(
              'form-control form-control--underlined form-control--wide no-min-width variable_value',
              {
                'form-control--inactive': pair.disabled
              }
            )}>
          ...
          {!hideButtons ? (
            <Button
              ...
              {pair.disabled ? (
                <i className="apiplus api-checkbox" />
              ) : (
                <i className="apiplus api-checkbox_checked" />
              )}
            </Button>
          ) : (
            <button>
...
KeyValueEditorRow.propTypes = {
  ...
  onFocusDesc: PropTypes.func.isRequired,
...
target.prototype.focusDescEnd = function() {
  this.handler.component.decoratedComponentInstance.focusDescEnd();
};
