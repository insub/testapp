...
class Editor extends PureComponent {
  ...
  _handleFocusDesc(pair) {
    this._setFocusedPair(pair);
    this._focusedField = DESC;
    this._rows[pair.id].focusDescEnd();
  }
  ...
  _updateFocus() {
    ...
    if (this._focusedField === NAME) {
      ...
      row.focusValueEnd();
    } else if (this._focusedField === DESC) {
      row.focusDescEnd();
    }
  }
        ...
        <ul className={classes}>
          {pairs.map((pair, i) => (
            <KeyValueEditorRow
              ...
              onFocusDesc={this._handleFocusDesc}
          ...
          {!maxPairs || pairs.length < maxPairs ? (
            <KeyValueEditorRow
              ...
              onFocusDesc={this._handleAddFromDesc}
              allowMultiline={allowMultiline}
              allowFile={allowFile}
              pair={{ name: '', value: ''}}
            />
