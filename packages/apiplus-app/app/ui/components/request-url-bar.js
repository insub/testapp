...
import HostDropdown from './dropdowns/host-dropdown';
...
class RequestUrlBar extends PureComponent {
  ...
  _handleClickSave(e) {
   hotkeys.executeHotKey(e, hotkeys.SAVE_REQUEST);
  }
  ...
  renderSendButton() {
    ...
    if (!cancelButton) {
      sendButton = (
        <Dropdown key="dropdown" className="send_request tall" right ref={this._setDropdownRef}>
          <DropdownButton
          ...
          <DropdownItem onClick={this.props.handleSaveAndPush}>
            <i className="fa fa-arrow-circle-o-right" /> Save & Sync
            <DropdownHint hotkey={hotkeys.SAVE_REQUEST} />
          </DropdownItem>
  ...
  render() {
    ...
    return (
      <KeydownBinder onKeydown={this._handleKeyDown}>
        <div className={`urlbar http-method-${method}` }>
          <MethodDropdown
          ...
          <HostDropdown 
            key={uniquenessKey} 
            hostChange={this._handleHostChange} 
            hosts={hosts} 
            host={host} 
          ...
          <form onSubmit={this._handleFormSubmit}>
            <OneLineEditor
              ...
              noHideScrollbars={true}
              lineWrapping={true}
              className={'url-editor'}
            />
            <div className="send_box">
              {this.renderSendButton()}
              <button className="send_dropdown" onClick={this._handleMetaClickSend}>
